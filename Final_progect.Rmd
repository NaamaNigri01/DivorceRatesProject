...
```{r load-data}
Demographic <- read_xlsx("Demographic.xlsx")
Population <- read_xlsx("Population.xlsx")
Divorces <- read_csv("Divorces.csv", show_col_types = FALSE)
Election <- read.csv("Election.csv", fileEncoding = "Windows-1255", quote = "")
Age <- read.csv("Age.csv", fileEncoding = "Windows-1255", quote = "")
